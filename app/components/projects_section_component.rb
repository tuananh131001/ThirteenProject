...
class ProjectsSectionComponent < ViewComponent::Base
  erb_template <<~ERB
      ...
      <div class="columns-1 gap-4 sm:columns-2 sm:grid-cols-2 sm:gap-4 sm:p-0  p-4 ">
        <%= render(ProjectCardComponent.new(thumbnail: "https://user-images.githubusercontent.com/67695658/214550280-6c2b6c64-67ba-4898-a060-a0b9372adc45.png",
          role: "Team leader",
        ...
        <%= render(ProjectCardComponent.new(thumbnail: "https://user-images.githubusercontent.com/67695658/178662828-ff1d16e7-3934-45ad-81f7-7da284e58716.png",
          role: "Team leader",
